...
YELLOW_SAPCE_SHIP = pygame.image.load(os.path.join('assets', 'pixel_ship_yellow.png'))
RED_SAPCE_SHIP = pygame.image.load(os.path.join('assets', 'pixel_ship_red_small.png'))
GREEN_SAPCE_SHIP = pygame.image.load(os.path.join('assets', 'pixel_ship_green_small.png'))
BLUE_SAPCE_SHIP = pygame.image.load(os.path.join('assets', 'pixel_ship_blue_small.png'))
...
class Player(Ship):
    def __init__(self, x, y, health = 100):
        ...
        self.ship_img = YELLOW_SAPCE_SHIP
...
class Enemy(Ship):
    COLOR_MAP = {
        'red' : (RED_SAPCE_SHIP, RED_LASER),
        'blue' : (BLUE_SAPCE_SHIP, BLUE_LASER),
        'green' : (GREEN_SAPCE_SHIP, GREEN_LASER)
    }
